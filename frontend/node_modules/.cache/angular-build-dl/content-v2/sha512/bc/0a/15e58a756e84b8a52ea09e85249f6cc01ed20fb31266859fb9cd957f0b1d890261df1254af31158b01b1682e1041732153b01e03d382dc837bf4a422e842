      ...
      var QueueMenuUserComponent = /*#__PURE__*/function () {
        ...
        _createClass(QueueMenuUserComponent, [{
          ...
          value: function printElem(elem) {
            ...
            queue_print += "0 -10 -13 -10 -30z'/>";
            queue_print += "</g>";
            queue_print += "</svg></div>"; // queue_print += "<div style='margin-top: 15px; width: 100px; height: 60px; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-color: #000; border-radius: 26%;'></div>"
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](QueueMenuUserComponent, [{
          ...
          return [{
            ...
            type: ngx_print_element__WEBPACK_IMPORTED_MODULE_5__["NgxPrintElementService"]
          }];
        }, null);
      })();
      /***/
