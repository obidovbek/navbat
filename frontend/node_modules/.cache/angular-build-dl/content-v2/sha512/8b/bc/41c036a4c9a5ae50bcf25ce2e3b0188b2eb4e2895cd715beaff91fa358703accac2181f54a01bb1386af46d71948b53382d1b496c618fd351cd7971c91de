(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-queue-menu-user-queue-menu-user-module"], {
    /***/
    "FD+4": function FD4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QueueMenuUserModule", function () {
        return QueueMenuUserModule;
      });
      /* harmony import */
      ...
      var _queue_menu_user_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./queue-menu-user-routing.module */
      "mwBw");
      /* harmony import */


      var _queue_menu_user_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./queue-menu-user.component */
      "VUMv");
      /* harmony import */
      ...
      var ngx_print_element__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ngx-print-element */
      "KyiH");

      var QueueMenuUserModule = function QueueMenuUserModule() {
        _classCallCheck(this, QueueMenuUserModule);
      };

      QueueMenuUserModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: QueueMenuUserModule
      });
      QueueMenuUserModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function QueueMenuUserModule_Factory(t) {
          return new (t || QueueMenuUserModule)();
        },
        providers: [],
        imports: [[_queue_menu_user_routing_module__WEBPACK_IMPORTED_MODULE_2__["QueueMenuUserRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ngx_print_element__WEBPACK_IMPORTED_MODULE_5__["NgxPrintElementModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](QueueMenuUserModule, {
          declarations: [_queue_menu_user_component__WEBPACK_IMPORTED_MODULE_3__["QueueMenuUserComponent"]],
          imports: [_queue_menu_user_routing_module__WEBPACK_IMPORTED_MODULE_2__["QueueMenuUserRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ngx_print_element__WEBPACK_IMPORTED_MODULE_5__["NgxPrintElementModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](QueueMenuUserModule, [{
    ...
    /***/
    "KyiH": function KyiH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NgxPrintElementDirective", function () {
        return NgxPrintElementDirective;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "NgxPrintElementService", function () {
        return NgxPrintElementService;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "NgxPrintElementComponent", function () {
        return NgxPrintElementComponent;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "NgxPrintElementModule", function () {
      ...
      * @return {?}
      */
      function callPrint(printWindow, iframe) {
      ...
      */
      function getBaseHref() {
        ...
        return "".concat(window.location.protocol, "//").concat(window.location.hostname).concat(port).concat(window.location.pathname);
      };
      /**
       * getMarkup
       * \@param elementHtml
      ...
      * @return {?}
      */
      function getMarkup(elementHtml, options) {
        /** @type {?} */
        ...
        html.push("<html><head><title>".concat(options.pageTitle || '', "</title>")); // If stylesheet URL's or list of stylesheet URL's are specified, override page stylesheets

        if (options.stylesheets) {
          stylesheets = Array.isArray(options.stylesheets) ? options.stylesheets : [options.stylesheets];
        } else {
          stylesheets = Array.prototype.slice.call(document.getElementsByTagName('link')).map(
          /**
          * @param {?} link
          * @return {?}
          */
        ...
        */
        function (f) {
          html.push("<link rel=\"".concat(f.rel, "\" href=\"").concat(f.href, "\">"));
        }); // If inline styles or list of inline styles are specified, override inline styles

        if (options.styles) {
          styles = Array.isArray(options.styles) ? [].concat(_toConsumableArray(options.styles), [".print-none { display: none; }"]) : [options.styles + ".print-none { display: none; }"];
        } else {
          styles = Array.prototype.slice.call(document.getElementsByTagName('style')).map(
          /**
          * @param {?} style
          * @return {?}
          */
        ...
        */
        function (style) {
          html.push("<style type=\"text/css\">".concat(style, "</style>"));
        });
        html.push("<base href=\"".concat(getBaseHref(), "\"/>"));
        html.push('</head><body class="pe-body">');
        html.push(elementHtml);
        html.push("\n    <script type=\"text/javascript\">\n      function printPage() {\n        focus();\n        print();\n        ".concat(options.printMode.toLowerCase() === 'popup' ? 'close();' : '', "\n      }\n    </script>\n  "));
        html.push('</body></html>');
        return html.join('');
      };
      /**
      ...
      */
      function printHtml(element) {
        ...
        var options = Object.assign({}, defaultOptions, selfOptions);
        /** @type {?} */
        ...
        if (options.printMode.toLowerCase() === 'popup') {
          ...
          printElementID = "printElement_".concat(Math.round(Math.random() * 99999).toString());
      ...
      var NgxPrintElementService = /*#__PURE__*/function () {
        function NgxPrintElementService() {
          _classCallCheck(this, NgxPrintElementService);
        }

        _createClass(NgxPrintElementService, [{
          key: "print",
          value:
          /**
           * Print
          ...
          function print(id, config) {
            ...
            switch (config && config.printMode) {
              case 'template':
                printHtml(container, Object.assign({}, config, {
                  printMode: ''
                }));
                break;
              ...
              default:
                if (container) {
                  ...
                  var $printSection = document.createElement('div'); // Add visibility hidden into body
      ...
      NgxPrintElementService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      ...
      NgxPrintElementService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({
        factory: function NgxPrintElementService_Factory() {
          return new NgxPrintElementService();
        },
        token: NgxPrintElementService,
        providedIn: "root"
      });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxPrintElementService, [{
      ...
      var NgxPrintElementDirective = /*#__PURE__*/function () {
        /**
         * @param {?} prints
         */
        function NgxPrintElementDirective(prints) {
          _classCallCheck(this, NgxPrintElementDirective);
        ...
        _createClass(NgxPrintElementDirective, [{
          key: "onClick",
      ...
      NgxPrintElementDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxPrintElementDirective, [{
      ...
      var NgxPrintElementComponent = /*#__PURE__*/function () {
        /**
         * @param {?} prints
         */
        function NgxPrintElementComponent(prints) {
          _classCallCheck(this, NgxPrintElementComponent);
        ...
        _createClass(NgxPrintElementComponent, [{
          key: "print",
          value: function print(id, config) {
      ...
      NgxPrintElementComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxPrintElementComponent, [{
      ...
      var NgxPrintElementModule = function NgxPrintElementModule() {
        _classCallCheck(this, NgxPrintElementModule);
      };

      NgxPrintElementModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NgxPrintElementModule
      });
      NgxPrintElementModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function NgxPrintElementModule_Factory(t) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxPrintElementModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
            declarations: [NgxPrintElementComponent, NgxPrintElementDirective],
            exports: [NgxPrintElementComponent, NgxPrintElementDirective]
    ...
    /***/
    "VUMv": function VUMv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QueueMenuUserComponent", function () {
        return QueueMenuUserComponent;
      });
      /* harmony import */
      ...
      var src_app_shared_service_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var ngx_print_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ngx-print-element */
      "KyiH");
      /* harmony import */
      ...
      function QueueMenuUserComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
          var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QueueMenuUserComponent_div_2_Template_div_click_0_listener() {
            ...
            return ctx_r3.selectedItem(idx_r2);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", item_r1[ctx_r0.lang === "en" ? "en" : ctx_r0.lang === "ru" ? "ru" : "uz"], " ");
        }
      }

      var QueueMenuUserComponent = /*#__PURE__*/function () {
        function QueueMenuUserComponent(dataService, httpService, router, print) {
          _classCallCheck(this, QueueMenuUserComponent);
        ...
        _createClass(QueueMenuUserComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "selectSymbol",
          value: function selectSymbol() {
            return this.dataService.menu[this.dataService.selected.index].inner_menu;
          }
        }, {
          key: "selectedItem",
          value: function selectedItem(idx) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      this.httpService.addQueue(this.dataService.changes).subscribe(function (res) {
                        console.log(res);

                        if (res.status === 200) {
                          _this.dataService.menu = res.menu;
                          _this.dataService.changes = [];
                          localStorage.setItem('changes', JSON.stringify(_this.dataService.changes));
                          localStorage.setItem('menu', JSON.stringify(res.menu));

                          _this.router.navigateByUrl('/#/infokios');
                        } else {
                          alert('Nimadur hato yana bir bor urinib ko‘ring!');
                        }
                      }, function (error) {
                        console.log('oflayn');
                        _this.dataService.menu[_this.dataService.selected.index].inner_menu[idx].queue.overall++;
                        localStorage.setItem('changes', JSON.stringify(_this.dataService.changes));
                      ...
                      this.service_name = this.dataService.menu[this.dataService.selected.index].inner_menu[idx][this.lang]; // alert('Navbat: '+ this.queue_number);
          ...
          value: function printElem(elem) {
            ...
            window.print();
            window.close();
            this.router.navigate(['/infokios']).then(function () {
      ...
      QueueMenuUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function QueueMenuUserComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QueueMenuUserComponent_Template__svg_svg_click_15_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](QueueMenuUserComponent, [{
          ...
          return [{
            ...
            type: src_app_shared_service_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"]
          }, {
            type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]
          }, {
            type: ngx_print_element__WEBPACK_IMPORTED_MODULE_6__["NgxPrintElementService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    "mwBw": function mwBw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QueueMenuUserRoutingModule", function () {
        return QueueMenuUserRoutingModule;
      });
      /* harmony import */
      ...
      var _queue_menu_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./queue-menu-user.component */
      "VUMv");
      ...
      var QueueMenuUserRoutingModule = function QueueMenuUserRoutingModule() {
        _classCallCheck(this, QueueMenuUserRoutingModule);
      };

      QueueMenuUserRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: QueueMenuUserRoutingModule
      });
      QueueMenuUserRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function QueueMenuUserRoutingModule_Factory(t) {
          return new (t || QueueMenuUserRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](QueueMenuUserRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](QueueMenuUserRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
...
//# sourceMappingURL=components-queue-menu-user-queue-menu-user-module-es5.js.map