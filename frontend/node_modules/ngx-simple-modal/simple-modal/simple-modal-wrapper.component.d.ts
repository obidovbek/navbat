...
export declare class SimpleModalWrapperComponent implements OnDestroy {
    ...
    addComponent<T, T1>(component: Type<SimpleModalComponent<T, T1>>): {
        ref: ComponentRef<SimpleModalComponent<T, T1>>;
        component: SimpleModalComponent<T, T1>;
    };
    /**
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<SimpleModalWrapperComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<SimpleModalWrapperComponent, "simple-modal-wrapper", never, {}, {}, never, never>;
}

//# sourceMappingURL=simple-modal-wrapper.component.d.ts.map