...
class QueueMenuUserComponent {
    ...
    selectedItem(idx) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.httpService.addQueue(this.dataService.changes).subscribe((res) => {
                console.log(res);
                if (res.status === 200) {
            ...
            this.queue_differ =
                this.dataService.menu[this.dataService.selected.index].inner_menu[idx]
                    ...
                    this.dataService.menu[this.dataService.selected.index].inner_menu[idx]
                        .queue.current;
            this.service_name =
                this.dataService.menu[this.dataService.selected.index].inner_menu[idx][this.lang];
