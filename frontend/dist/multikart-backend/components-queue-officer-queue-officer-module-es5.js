    ...
    "YFa9": function YFa9(module, __webpack_exports__, __webpack_require__) {
      ...
      function QueueOfficerComponent_div_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](3, "Navbat");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function QueueOfficerComponent_div_3_Template_button_click_6_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4);

            var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r3.nextItem();
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](7, "Kiyingi");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](10, "ng2-smart-table", 11);
      ...
      function QueueOfficerComponent_div_4_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var QueueOfficerComponent = /*#__PURE__*/function () {
        function QueueOfficerComponent(httpService, dataService, authService, socket) {
          ...
          this.authService.user.subscribe(function (user) {
            ...
            _this.type_services = user.services;
            _this.user_symbol = user.officer_id;
        ...
        _createClass(QueueOfficerComponent, [{
          ...
          value: function nextItemHttpReq(menu_idx, menu_sub_idx, service_title_idx) {
            ...
            this.httpService.officerNextItem(menu_idx, menu_sub_idx).subscribe(function (res) {
              ...
              if (res.status === 200) {
                ...
                alert("Nimadur hato ketti yana bir bor urinib ko‘ring!"); // window.location.reload();
              }
            }, function (error) {
          ...
          value: function getMenu(i) {
            ...
            this.httpService.getMenu().subscribe(function (res) {
              ...
              if (res.status === 200) {
                _this4.dataService.menu = res.menu;

                _this4.genTable('load');
              } else {
                alert("Bazaka ulana olmadim yana bir bor urinib ko‘ring!");
          ...
          value: function genTable(type) {
            ...
            var items = [];
            this.dataService.menu.forEach(function (menu) {
      ...
      QueueOfficerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 5,
        vars: 3,
        consts: [[1, "container-fluid"], [1, "card"], ["class", "card-header", 4, "ngIf"], [4, "ngIf"], ["class", "lds-wrap", 4, "ngIf"], [1, "card-header"], [1, "card-body"], [1, "btn-popup", "pull-right"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], ["id", "batchDelete", 1, "category-table", "custom-datatable", "transcation-datatable", "user-image"], [1, "table-responsive"], [3, "settings", "source"], [1, "lds-wrap"], [1, "lds-dual-ring"]],
        template: function QueueOfficerComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](3, QueueOfficerComponent_div_3_Template, 11, 2, "div", 3);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](4, QueueOfficerComponent_div_4_Template, 2, 0, "div", 4);
          }
