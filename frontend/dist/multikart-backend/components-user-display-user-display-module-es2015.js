...
/* harmony import */ var src_app_shared_service_websocket_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/service/websocket.service */ "yrUK");
...
class UserDisplayComponent {
    ...
    getStatistics() {
        this.httpService.getStatistics().subscribe((res) => {
            console.log('res', res);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserDisplayComponent, [{
    ...
    }], function () { return [{ type: src_app_shared_service_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"] }, { type: src_app_shared_service_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] }, { type: src_app_shared_service_websocket_service__WEBPACK_IMPORTED_MODULE_4__["WebsocketService"] }]; }, { audio: [{
