(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-user-display-user-display-module"], {
    ...
    "nJJ3": function nJJ3(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_service_websocket_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var UserDisplayComponent = /*#__PURE__*/function () {
        ...
        _createClass(UserDisplayComponent, [{
          ...
          key: "nextUserDisplay",
          value: function nextUserDisplay() {
            var _this3 = this;

            this.getStatistics();
            this.socket.nextUserDisplay.subscribe(function (res) {
              if (res) {
                console.log(res.data);
                _this3.current_queues_new = res.data;
                ...
                setTimeout(function () {
                  ...
                  _this3.current_queues.forEach(function (h, h_idx) {
                    if (h.officer_id && h.officer_id === res.data.officer_id) {
                      found = true;
                      _this3.current_queues[h_idx] = res.data;
                    }

                    if (h_idx + 1 === _this3.current_queues.length && !found) {
                      _this3.current_queues.push(res.data);
                    }
                  });
                ...
                }, 5000); // if(this.current_queues.find(h=>(!h.officer_id)||(h.officer_id!==res.data.officer_id))){
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserDisplayComponent, [{
          ...
          return [{
            ...
            type: src_app_shared_service_websocket_service__WEBPACK_IMPORTED_MODULE_3__["WebsocketService"]
          }];
        }, {
          audio: [{
