...
class NavService {
    ...
    getMenuItemsAdmin() {
        this.MENUITEMS = [
            {
                title: 'Menu qo‘shish', path: '/queue', icon: 'home', type: 'link', active: false
            },
            {
...
class AuthService {
    ...
    autoLog() {
        this.user = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(user => {
            if (user) {
                return this.db.doc(`users/${user.uid}`).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => {
                    data['id'] = user.uid;
    ...
    signIn(credentials) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.afAuth.signInWithEmailAndPassword(credentials.email, credentials.password)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(user => {
            if (user) {
                return this.db.doc(`users/${user.user.uid}`).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1));
            }
            else {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
            }
...
class LoginComponent {
    constructor(fb, router, auth, formBuilder) {
        this.fb = fb;
        this.router = router;
        this.auth = auth;
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _shared_service_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }]; }, { tabSet: [{
...
class AutoLoginGuard {
    ...
    canActivate(route) {
        ...
        return this.auth.user.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(user => {
            if (!user) {
                return true;
            }
            else {
...
AutoLoginGuard.ɵfac = function AutoLoginGuard_Factory(t) { return new (t || AutoLoginGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"])); };
AutoLoginGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: AutoLoginGuard, factory: AutoLoginGuard.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AutoLoginGuard, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _shared_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }]; }, null); })();
...
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 9, vars: 0, consts: [[1, "navbar"], ["href", "https://navbat.ferpi.uz/#/infokios"], ["href", "https://navbat.ferpi.uz/#/display"], ["href", "https://navbat.ferpi.uz/#/queue-officer"], ["href", "https://navbat.ferpi.uz/#/queue"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
...
AuthGuard.ɵfac = function AuthGuard_Factory(t) { return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"])); };
...
function ListUserComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("deleteConfirm", function ListUserComponent_div_0_Template_ng2_smart_table_deleteConfirm_11_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.onDeleteConfirm($event); })("editConfirm", function ListUserComponent_div_0_Template_ng2_smart_table_editConfirm_11_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.onEditConfirm($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
ListUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListUserComponent, selectors: [["app-list-user"]], decls: 2, vars: 2, consts: [["class", "container-fluid", 4, "ngIf"], ["class", "lds-wrap", 4, "ngIf"], [1, "container-fluid"], [1, "card"], [1, "card-header"], [1, "card-body"], [1, "btn-popup", "pull-right"], [1, "btn", "btn-primary", 3, "routerLink"], ["id", "batchDelete", 1, "category-table", "custom-datatable", "transcation-datatable", "user-image"], [1, "table-responsive"], [3, "settings", "source", "deleteConfirm", "editConfirm"], [1, "lds-wrap"], [1, "lds-dual-ring"]], template: function ListUserComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.tmp.loading);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], ng2_smart_table__WEBPACK_IMPORTED_MODULE_5__["Ng2SmartTableComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJsaXN0LXVzZXIuY29tcG9uZW50LnNjc3MifQ== */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListUserComponent, [{
    ...
    }], function () { return [{ type: src_app_shared_service_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"] }, { type: src_app_shared_service_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"] }]; }, null); })();
...
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! firebase/app */ "Jgta");
/* harmony import */ var firebase_storage__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! firebase/storage */ "WI49");
/* harmony import */ var firebase_analytics__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! firebase/analytics */ "AAub");
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! firebase/auth */ "6nsN");
/* harmony import */ var firebase_database__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! firebase/database */ "Zs65");
/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! firebase/firestore */ "5x/H");
/* harmony import */ var ngx_socket_io__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ngx-socket-io */ "7JkF");
...
const config = { url: 'wss://ferpi.tsnqb.uz/socket.io', options: { transports: ['websocket'] } };
class AppModule {
    constructor() {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]], imports: [_angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"],
        ...
        _angular_fire_auth__WEBPACK_IMPORTED_MODULE_14__["AngularFireAuthModule"], ngx_simple_modal__WEBPACK_IMPORTED_MODULE_17__["SimpleModalModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_18__["HttpClientModule"], ngx_socket_io__WEBPACK_IMPORTED_MODULE_26__["SocketIoModule"]] }); })();
